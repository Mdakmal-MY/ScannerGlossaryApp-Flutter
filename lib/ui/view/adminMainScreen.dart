...
import 'package:ocrglossary/ui/widgets/AdminDrawer.dart';
import 'package:ocrglossary/ui/widgets/LoadingScreen.dart';
import 'package:ocrglossary/ui/widgets/chart/linechart.dart';
            ...
            children: <Widget>[
              ...
              StreamBuilder(
                ...
                builder:(context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if(snapshot.hasData){
                    allUser = snapshot.data.documents
                    ...
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text("Total User Registered",
                        style: TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 18,

                        ),),
                        subtitle: Text("${allUser.length}", style: TextStyle(
                          fontSize: 20,
                        ),),
                      ),
                    );
